...
public class BodyPartFragment extends Fragment {
    ...
    private final String iDsKey = "id_list";
    private final String indexKey = "id_index";
    // Tag for logging
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            mListIndex = savedInstanceState.getInt(indexKey);
            mImageIds = savedInstanceState.getIntegerArrayList(iDsKey);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putIntegerArrayList(iDsKey, (ArrayList<Integer>) mImageIds);
        outState.putInt(indexKey, mListIndex);
    }
}
